defmodule LearnElixirGraphqlWeb do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use LearnElixirGraphqlWeb, :controller
      use LearnElixirGraphqlWeb, :view
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/learn_elixir_graphql_web/templates",
        namespace: LearnElixirGraphqlWeb
